...
[**Run an encrypted exchange in your browser**](https://open-e2ee.dev/playground) · [Edit on StackBlitz](https://stackblitz.com/fork/github/open-e2ee/signal-protocol-js/tree/v6.0.0/examples/browser) · [Run on Expo / Hermes](./examples/expo/README.md)
...
Version `6.0.x`. Public APIs and persisted formats follow semantic versioning.
