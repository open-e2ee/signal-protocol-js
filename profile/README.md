...
The profile module generates profile keys, encrypts padded profile fields,
stores the current user's profile key, tracks received contact profile state,
and coordinates encrypted profile updates.
