...
// release renames it, this mount is silently skipped, the deploy still
// succeeds, and the first symptom is every fetchPreKeyBundle failing at
// runtime (the rate limiter's function references resolve to a missing
// child component). If prekey fetches start erroring after a convex
// upgrade, check this guard first.
if (
  typeof (
